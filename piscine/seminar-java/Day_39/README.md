...
- Solutions: [solutions_day39/](solutions_day39/)
...
## Actions
- **Ex01 - Inspector** : Classe générique pour inspecter les classes avec Reflection.  
- **Reflection API** : Class, Method, Field, getDeclaredMethods(), getDeclaredFields().  
- **Annotations** : @Override, @BeforeClass, @AfterClass, @Before, @After.  
- **Javadoc** : Documentation automatique du code avec commentaires spéciaux.  
