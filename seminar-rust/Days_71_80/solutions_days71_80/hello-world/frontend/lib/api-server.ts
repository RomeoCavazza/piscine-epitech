...
export async function updateMemberRole(
  ...
  return fetchApi<ServerMember>(`/servers/${serverId}/members/${userId}`, {
    method: "PUT",
...
export async function kickMember(serverId: string, userId: string): Promise<void> {
  await fetchApi<void>(`/servers/${serverId}/members/${userId}/kick`, {
    method: "POST",
  });
}
...
export async function banMember(
  ...
  return fetchApi<Ban>(`/servers/${serverId}/members/${userId}/ban`, {
    method: "POST",
    body: JSON.stringify(payload),
  });
}
...
export async function unbanMember(serverId: string, userId: string): Promise<void> {
  await fetchApi<void>(`/servers/${serverId}/members/${userId}/unban`, {
    method: "POST",
  });
}

export async function listBans(serverId: string): Promise<BanWithUser[]> {
  return fetchApi<BanWithUser[]>(`/servers/${serverId}/bans`);
}
