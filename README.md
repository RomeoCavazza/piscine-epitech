...
Il est structuré en trois séminaires:
...
- 💻 `solutions_dayXX/` — solutions (shell, HTML/CSS/JS, PHP)
...
- **Days 21–30** — [Consignes](seminar-job-board/consignes_day21-30.pdf) · [README](seminar-job-board/README.md) · [Implémentation](seminar-job-board/DAY_21_30/)
